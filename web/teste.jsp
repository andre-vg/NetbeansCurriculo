            ...
            <section id="about" class="about">
              <div class="container">
                <div class="section-title">
                  <h2>Sobre</h2>
                  <p>Prazer meu nome é André e atualmente sou Estudante do 4° Semestre de Ciência da Computação no Centro Educacional CEUB e procuro novas oportunidades na área da
                ...
                <div class="row">
                  ...
                  <div class="col-lg-8 pt-4 pt-lg-0 content">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <ul>
                          <li><i class="bi bi-arrow-right"></i> <strong>Idade:</strong> <span>20</span></li>
                          <li><i class="bi bi-arrow-right"></i> <strong>Formação:</strong> <span>Ensino Superior em curso</span></li>
                          <li><i class="bi bi-arrow-right"></i> <strong>Email:</strong> <span>avictorg@gmail.com</span></li>
                          <li><i class="bi bi-arrow-right"></i> <strong>Estado Civil:</strong> <span>Offline</span></li>
                        </ul>
                      </div>
                    </div>
                    <p>
                      Todas as informações estão corretas e foram atualizadas no dia 16/11/2021. 
                    </p>
                  </div>
                </div>
              </div>
